...
#include "../../../Sources/Headers/httpmanager.h"
...
void HttpManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HttpManager::sig_http_finish; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &HttpManager::sig_reg_mod_finish; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HttpManager::sig_http_finish(ReqId _t1, QString _t2, ErrorCodes _t3, Modules _t4)
{
...
// SIGNAL 1
void HttpManager::sig_reg_mod_finish(ReqId _t1, QString _t2, ErrorCodes _t3)
{
